...
class ScatterplotD3 {
  ...
  updateAxis = function (visData, xAttribute, yAttribute) {
    ...
    // this.xScale.domain(...);
    // this.yScale.domain(...);
    const xMin = d3.min(visData, (item) => item[xAttribute]);
    const xMax = d3.max(visData, (item) => item[xAttribute]);
    const yMin = d3.min(visData, (item) => item[yAttribute]);
    const yMax = d3.max(visData, (item) => item[yAttribute]);
